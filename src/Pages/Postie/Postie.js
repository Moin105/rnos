...
function Postie() {
  return (
    <>
      <div className='background-postie'>
        <Header color="#ffffff" />
        <div className='head'>
            <h2 className='heading'>Post an <span>Item</span>  or <span>Experience</span></h2>
          {/* <Heading color="white" content="How It works" textAlign="center" /> */}
        
           <h5>Trust Us you won’t Regret it</h5>
          <p className='texta'>
          Why buy expensive items you’ll rarely use when you can Rent items in your community for low prices instead? As a lender you will earn money for items you already have and on the schedule you want. You can also rent out space for unique and private experiences.               </p>  
          <Button name="Lets Go!" color="#ffffff" bg="#F21B2D" />
        </div>
